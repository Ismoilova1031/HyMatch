...
export const iconMap = {
  ...
  calendarISvg: require('../assets/images/icons/SVG/calendar_i.svg'),
  chineSvg: require('../assets/images/icons/SVG/chine.svg'),
  clockSvg: require('../assets/images/icons/SVG/clock.svg'),
  clockISvg: require('../assets/images/icons/SVG/clock_i.svg'),
  coinSvg: require('../assets/images/icons/SVG/coin.svg'),
  coinISvg: require('../assets/images/icons/SVG/coin_i.svg'),
  companySvg: require('../assets/images/icons/SVG/company.svg'),
  companyISvg: require('../assets/images/icons/SVG/company_i.svg'),
  ...
  languageISvg: require('../assets/images/icons/SVG/language_i.svg'),
  ...
  starISvg: require('../assets/images/icons/SVG/star_i.svg'),
  stepsSvg: require('../assets/images/icons/SVG/steps.svg'),
  stepsISvg: require('../assets/images/icons/SVG/steps_i.svg'),
  todoSvg: require('../assets/images/icons/SVG/todo.svg'),
  todoISvg: require('../assets/images/icons/SVG/todo_i.svg'),
  trainCoinSvg: require('../assets/images/icons/SVG/train_coin.svg'),
  trainSvg: require('../assets/images/icons/SVG/train.svg'),
  trainISvg: require('../assets/images/icons/SVG/train_i.svg'),
